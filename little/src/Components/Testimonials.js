    ...
    <section className="testimonials">
        <div className="review-container">
            ...
            <div className="image-container">
                <img alt="A man with black hair and a black t-shirt" src={Marcus}></img>
            </div>
            <h2>Marcus</h2>
        ...
        <div className="review-container">
            ...
            <div className="image-container">
                <img alt="A woman with black curly hair and a light blue shirt" src={Mosalowa}></img>
            </div>
            <h2>Mosalowa</h2>
        ...
        <div className="review-container">
            ...
            <div className="image-container">
                <img alt="A woman with bright red hair and a black puffer jacket" src={Ann}></img>
            </div>
            <h2>Ann</h2>
